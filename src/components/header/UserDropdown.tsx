    ...
    <div className="relative">
      ...
      >
        ...
        <div className="mt-3">
          {user ? (
            <button
              onClick={(e) => { e.preventDefault(); closeDropdown(); signOut(); }}
              className="w-full text-left px-3 py-2 rounded-lg text-theme-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400"
            >
              Sign out
            </button>
          ) : (
            <button
              onClick={(e) => { e.preventDefault(); closeDropdown(); signIn(); }}
              className="w-full text-left px-3 py-2 rounded-lg text-theme-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400"
            >
              Sign in
            </button>
